# ───────────────────────────────────────────────
# 💡 CÓDIGO PARA TABLA DE ACUMULADOS 💡
# ───────────────────────────────────────────────
# ───────────────────────────────────────────────
...
# ───────────────────────────────────────────────
  ...
  # Generar condiciones dinámicas para los años deseados
...
# ───────────────────────────────────────────────
# Crear lista para títulos de la ppt
# ───────────────────────────────────────────────
...
generar_mini_tabla_delito <- function(nombre_delito, df) {
  ...
  # Las abreviaciones sirven para que los nombres de la stablas sean más cortos, 
  #si se agrega un delito al listado de delitos_deseados habría que pensar en una abreviación 
...
# ───────────────────────────────────────────────
#  3. Ejecutar para delitos específicos
# ───────────────────────────────────────────────
delitos_deseados <- c(
  "Alto Impacto",
  "Homicidio doloso",
...
# ───────────────────────────────────────────────
# 💡 CÓDIGO PARA MINI TABLA DE DELITOS EN EL ESPACIO PÚBLICO 💡
# ───────────────────────────────────────────────
# ───────────────────────────────────────────────
# 1. Definir delitos que forman el total
# ───────────────────────────────────────────────
...
# ───────────────────────────────────────────────
# 4. Crear etiquetas dinámicas de columna
# ───────────────────────────────────────────────
fecha_corte <- floor_date(Sys.Date(), unit = "month")
fecha_ultimo_mes <- fecha_corte - months(1)
nombre_mes <- format(fecha_ultimo_mes, "%b") |> tools::toTitleCase()
